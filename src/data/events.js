...
export const events = [
  ...
  },
  {
    ...
    about: [
      ...
      "Oct 5 — arrangements 11:00 AM – 12:30 PM, the Expo 1:30 PM – 4:00 PM. Advance registration required; bring your own materials and circuits. Dedicated display tables, power supply, electrical safety arrangements and exhibition space provided at the Main Block ground floor.",
    ],
    date: "OCT 5, 2026",
  ...
  /* ---------------------------- THE ARENA ---------------------------- */
  {
    ...
    mode: "5V5 TACTICAL",
    realm: "arena",
    tagline: "Five enter.\nOnly one bracket survives.",
    about: [
      "The flagship Nexus title. Double-elimination brackets, streamed on the arena wall, decided by a single best-of-five grand final.",
      "Sign up as a squad or get drafted into the open pool. Check-in opens one hour before the first whistle.",
    ],
    date: "AFTER COLLEGE HOURS",
    venue: "THE ARENA — MAIN STAGE",
    teamSize: "5 + 1 SUB",
    status: "BRACKET OPEN",
    accent: "violet",
    sigil: "squad",
    linkKey: "neonVanguard",
  },
  {
    id: "velocity-rift",
    number: "GAME 02",
    ...
    realm: "arena",
    tagline: "No brakes.\nNo mercy. No second lap.",
    about: [
      "A pure-speed time trial league. Three heats, ghost races against your own best run, and a live leaderboard that never sleeps.",
      "Solo entrants only. Vehicles are balanced — the rift rewards nerve over setup.",
    ],
    date: "AFTER COLLEGE HOURS",
    venue: "THE ARENA — SIM BAY",
    teamSize: "SOLO",
    status: "QUALIFIERS LIVE",
    accent: "gold",
    sigil: "rift",
    linkKey: "velocityRift",
  },
  {
    id: "titan-protocol",
    number: "GAME 03",
    ...
    mode: "5V5 MOBA",
    realm: "arena",
    tagline: "Claim the lane.\nHold the nexus.",
    about: [
      "Team strategy under pressure — draft, lane, siege. Group stage runs all day; the top four advance to the primetime final.",
      "Full rosters of five with one substitute. Matches are best-of-three, grand final best-of-five.",
    ],
    date: "AFTER COLLEGE HOURS",
    venue: "THE ARENA — MAIN STAGE",
    teamSize: "5 + 1 SUB",
